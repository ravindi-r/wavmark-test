...
class Model(nn.Module):
    ...
    def encode(self, signal, message):
        #print("encode start")
        #print("\t\t\t\tencode start: ", signal.shape)
        ...
        # print("encode end")
        #print("\t\t\t\tencode end: ", signal_wmd.shape)
        return signal_wmd
    ...
    def decode(self, signal):
        ...
        #print("\t\tdecode start: ", signal.shape)
        signal_fft = self.stft(signal)
        watermark_fft = signal_fft
